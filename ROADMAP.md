...
> **Status:** 156 regression tests pass. v1.x bug-fix phase complete. v2.0.x template strings, f-string format spec, Pattern Matching, Tween, Sequence, Story, Scene Tree, Resource Manager, ECS, ipp-io, and ipp-log package series complete.
...
**Current: v2.0.13** — VERSION in `ipp/main.py` = `"2.0.13"`.
...
- **v2.0.14** onwards (see version history in README.md for planned features)
